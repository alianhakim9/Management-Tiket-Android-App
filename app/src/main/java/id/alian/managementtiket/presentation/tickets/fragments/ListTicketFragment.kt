...
import id.alian.managementtiket.databinding.FragmentListTicketPaginationBinding
...
class ListTicketFragment :
    BaseFragment<FragmentListTicketPaginationBinding>(FragmentListTicketPaginationBinding::inflate) {

    private val viewModel: TicketViewModel by viewModels()
    private val adapter: TicketPaginateAdapter by lazy { TicketPaginateAdapter() }

    override fun FragmentListTicketPaginationBinding.initialize() {
        setupRecyclerView()
